...
## 5.1.1 - 2026-07-20
- Updated marketplace screenshots with new UI

## 5.1.0 - 2026-07-06
- Refreshed UI for UsersFlow
...
## 5.0.8 - 2026-02-09
- Fixed issue where clicking interaction headers would show a multi-site error

## 5.0.7 - 2026-01-02
- Added code to not call saveViewDataTableParameters for anonymous user
