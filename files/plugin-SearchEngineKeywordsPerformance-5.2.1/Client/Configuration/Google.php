...
class Google extends BaseConfiguration
{
    ...
    public function getAccounts()
    {
        if (empty($this->accounts)) {
            ...
            $accounts = $this->decryptOptionValue($accounts);
    ...
    public function getClientConfig()
    {
        if (empty($this->clientConfig)) {
            ...
            $config = $this->decryptOptionValue($config);
    ...
    {
        Option::set(self::CLIENT_CONFIG_OPTION_NAME, $this->getEncryption()->encryptString($config));
    }
    /**
    ...
    private function decryptOptionValue($value)
    {
        ...
        return $this->getEncryption()->decryptString($value);
    }
