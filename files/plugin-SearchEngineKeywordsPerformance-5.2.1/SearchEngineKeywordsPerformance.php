 ...
 * Description: Discover which search keywords drive traffic, engagement, and conversions. Get the keyword insights behind "Keyword not defined" with data from Google Search Console, Bing Webmaster Tools, Yandex Webm
 * Author: InnoCraft
...
class SearchEngineKeywordsPerformance extends \Piwik\Plugin
{
    ...
    public function getClientSideTranslationKeys(&$translationKeys)
    {
        ...
        $translationKeys[] = 'SearchEngineKeywordsPerformance_BingAccountErrorNew';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_AccountNoAccessNew';
        ...
        $translationKeys[] = 'SearchEngineKeywordsPerformance_VisitBingApiKeyHowTo';
        ...
        $translationKeys[] = 'SearchEngineKeywordsPerformance_ConnectGoogleAccountsText';
        ...
        $translationKeys[] = 'SearchEngineKeywordsPerformance_OAuthErrorNew';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_AccountConnectionValidationErrorNew';
        ...
        $translationKeys[] = 'SearchEngineKeywordsPerformance_OAuthAccessTimedOutNew';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_OAuthAccessWillTimeOutSoonNew';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_Reauthenticate';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_ConnectUsingMatomoCloudApp';
        ...
        $translationKeys[] = 'SearchEngineKeywordsPerformance_AdvancedStep1Title';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_StepByStepInstructions';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_AdvancedStep2Title';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_AdvancedStep2Desc';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_AdvancedStep3Title';
        $translationKeys[] = 'SearchEngineKeywordsPerformance_AdvancedStep3Desc';
        $translationKeys[] = "SearchEngineKeywordsPerformance_ConfigurationDescriptionLine1New";
        $translationKeys[] = "SearchEngineKeywordsPerformance_ConfigurationDescriptionLine2New";
        $translationKeys[] = "SearchEngineKeywordsPerformance_FixConfiguration";
        $translationKeys[] = "SearchEngineKeywordsPerformance_ConfigurationProblemDetected";
        $translationKeys[] = "SearchEngineKeywordsPerformance_ConfigurationProblemDescription";
        $translationKeys[] = "SearchEngineKeywordsPerformance_GoogleAccount";
        $translationKeys[] = "SearchEngineKeywordsPerformance_YandexAccount";
        $translationKeys[] = "SearchEngineKeywordsPerformance_AddedBy";
        $translationKeys[] = "SearchEngineKeywordsPerformance_TimeAdded";
        $translationKeys[] = "SearchEngineKeywordsPerformance_AvailableWebsitesForImport";
        $translationKeys[] = "SearchEngineKeywordsPerformance_UnverifiedWebsites";
        $translationKeys[] = "SearchEngineKeywordsPerformance_Status";
        $translationKeys[] = "SearchEngineKeywordsPerformance_Active";
        $translationKeys[] = "SearchEngineKeywordsPerformance_InvalidUrl";
        $translationKeys[] = "SearchEngineKeywordsPerformance_AuthenticationFailed";
        $translationKeys[] = "SearchEngineKeywordsPerformance_ActiveTooltip";
        $translationKeys[] = "SearchEngineKeywordsPerformance_InvalidUrlTooltip";
        $translationKeys[] = "SearchEngineKeywordsPerformance_AuthenticationFailedTooltip";
        $translationKeys[] = "SearchEngineKeywordsPerformance_NoWebsiteAccess";
        $translationKeys[] = "SearchEngineKeywordsPerformance_Setup";
        $translationKeys[] = "SearchEngineKeywordsPerformance_NavTitleGoogle";
        $translationKeys[] = "SearchEngineKeywordsPerformance_NavTitleBing";
        $translationKeys[] = "SearchEngineKeywordsPerformance_NavTitleYandex";
