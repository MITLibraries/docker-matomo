...
class Encryption
{
    ...
    public function encryptString(
        ...
        if (!extension_loaded('openssl')) {
            throw new SecretConfigurationException(Piwik::translate('SearchEngineKeywordsPerformance_EncryptionOpenSslRequiredEncrypt'));
        }
        ...
        if (!is_string($ciphertext)) {
            throw new SecretConfigurationException(Piwik::translate('SearchEngineKeywordsPerformance_EncryptionEncryptFailed'));
        }
    ...
    public function decryptString(
        ...
        if (!extension_loaded('openssl')) {
            throw new SecretConfigurationException(Piwik::translate('SearchEngineKeywordsPerformance_EncryptionOpenSslRequiredDecrypt'));
        }
    ...
    {
        return Piwik::translate('SearchEngineKeywordsPerformance_EncryptionKeyMissingOrInvalid');
    }
}
