 ...
 */
namespace Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\Credentials;

use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\CredentialSource\AwsNativeSource;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\CredentialSource\FileSource;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\CredentialSource\UrlSource;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\ExternalAccountCredentialSourceInterface;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\FetchAuthTokenInterface;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\GetQuotaProjectInterface;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\HttpHandler\HttpClientCache;
...
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\UpdateMetadataInterface;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\UpdateMetadataTrait;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Psr7\Request;
...
class ExternalAccountCredentials implements FetchAuthTokenInterface, UpdateMetadataInterface, GetQuotaProjectInterface
{
    ...
    /**
     * @var \Matomo\Dependencies\SearchEngineKeywordsPerformance\Google\Auth\OAuth2
     */
    private $auth;
    /**
     * @var string|null
