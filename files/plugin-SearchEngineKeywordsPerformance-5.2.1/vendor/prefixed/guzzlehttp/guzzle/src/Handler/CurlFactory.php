...
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Psr7\LazyOpenStream;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function createRejection(EasyHandle $easy, array $ctx) : PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri) : string
    {
        ...
        $redactedUriString = \Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
