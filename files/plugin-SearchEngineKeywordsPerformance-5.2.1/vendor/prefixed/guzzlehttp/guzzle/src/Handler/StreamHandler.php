...
namespace Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Handler;
...
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Promise as P;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Promise\FulfilledPromise;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Promise\PromiseInterface;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Psr7;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\TransferStats;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Utils;
...
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Psr\Http\Message\StreamInterface;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\Psr\Http\Message\UriInterface;
/**
...
class StreamHandler
{
    ...
    private function createStream(RequestInterface $request, array $options)
    {
        ...
        return $this->createResource(function () use($uri, $contextResource, $context, $options, $request) {
            ...
            if (function_exists('Matomo\\Dependencies\\SearchEngineKeywordsPerformance\\http_get_last_response_headers')) {
                /** @var array|null */
                $http_response_header = \Matomo\Dependencies\SearchEngineKeywordsPerformance\http_get_last_response_headers();
            }
