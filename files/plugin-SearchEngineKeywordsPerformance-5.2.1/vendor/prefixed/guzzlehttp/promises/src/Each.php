...
final class Each
{
    ...
    private static function prepareIterable($iterable, string $method) : iterable
    {
        ...
        \Matomo\Dependencies\SearchEngineKeywordsPerformance\trigger_deprecation('guzzlehttp/promises', '2.5', 'Passing a non-iterable to %s::%s() is deprecated; guzzlehttp/promises 3.0 will require an iterable.', self::class, $method);
        return [$iterable];
    }
}
