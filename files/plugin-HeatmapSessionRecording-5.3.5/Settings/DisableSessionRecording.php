...
if (
    ...
    class_alias(DisableSessionRecordingNoInterfaces::class, DisableSessionRecording::class);
} else {
    class DisableSessionRecording implements
        ...
        SystemSettingInterface
    {
        ...
        */
        ...
        {
            return 'disableSessionRecording';
        }
        ...
        {
            return Piwik::translate('HeatmapSessionRecording_PolicySessionRequirementNote');
        }
        ...
        {
            return Piwik::translate('HeatmapSessionRecording_PolicySessionTitle');
        }
