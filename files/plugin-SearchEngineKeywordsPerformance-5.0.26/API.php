...
class API extends \Piwik\Plugin\API
{
     ...
     *
     * @param string|int|array<int> $idSite  A single ID (eg, `'1'`), multiple IDs (eg, `'1,2,3'` or `array(1, 2, 3)`),
     *                                      or `'all'`.
     ...
     * @return DataTable|DataTable\Map Keyword report merged with referrer search keywords.
     */
     ...
     * @param Date|string      $date    'YYYY-MM-DD', magic keywords (ie, 'today'; {@link Date::factory()}
     *                                  or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD').
     * @return DataTable|DataTable\Map Combined imported keyword report.
     */
     ...
     * @param Date|string      $date    'YYYY-MM-DD', magic keywords (ie, 'today'; {@link Date::factory()}
     *                                  or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD').
     * @return DataTable|DataTable\Map Combined Google keyword report.
     */
     ...
     * @param Date|string      $date    'YYYY-MM-DD', magic keywords (ie, 'today'; {@link Date::factory()}
     *                                  or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD').
     * @return DataTable|DataTable\Map Bing keyword report for the requested period.
     */
     ...
     * @param Date|string      $date    'YYYY-MM-DD', magic keywords (ie, 'today'; {@link Date::factory()}
     *                                  or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD').
     * @return DataTable|DataTable\Map Bing crawling overview metrics.
     */
     ...
     * @param Date|string      $date    'YYYY-MM-DD', magic keywords (ie, 'today'; {@link Date::factory()}
     *                                  or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD').
     * @return DataTable|DataTable\Map Yandex crawling overview metrics.
     */
     ...
     *
     * @param int|string $idSite  Site ID to fetch crawl error examples for.
     *
     * @return DataTable Crawl error example rows, with URL metadata.
     */
