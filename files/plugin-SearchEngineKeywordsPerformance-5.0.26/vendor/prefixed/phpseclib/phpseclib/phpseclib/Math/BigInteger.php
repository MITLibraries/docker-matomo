 ...
 */
namespace Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Math;
...
class BigInteger implements \JsonSerializable
{
    ...
    {
        self::$engines = [];
        $fqmain = 'Matomo\\Dependencies\\SearchEngineKeywordsPerformance\\phpseclib3\\Math\\BigInteger\\Engines\\' . $main;
