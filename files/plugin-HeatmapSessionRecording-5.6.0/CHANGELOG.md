...
5.6.0 - 2026-08-03
- Added option to export heatmaps to png
- Added a heatmap settings menu with a new delete and retake snapshot workflow
- Added empty state screens for heatmaps without a snapshot
- Deleting a snapshot is now possible for heatmaps that have finished recording
- The `HeatmapSessionRecording.deleteHeatmapScreenshot` API now accepts a `captureManually` parameter

5.5.4 - 2026-07-27
- Updated 2FA logic
- Added unsubscribe button to email when heatmap or session recording has finished 

5.5.3 - 2026-07-20
- Updated Marketplace description
- Updated the finished heatmap and session recording email links in order to show the correct notification if the heatmap or session recording was deleted

5.5.2 - 2026-07-13
- Updated heatmap colors to be more accessible
- Removed horizontal line on target page component 

5.5.1 - 2026-07-06
- Added two modes to target component, simple & advanced
- Redesigned view heatmap report page

5.5.0 - 2026-06-29
- Added email to notify create user when heatmap or session recording has finished

5.4.1 - 2026-06-22
- Added code to harden the client-side check before displaying DOM values
- Added code to make advanced settings an accordion

5.4.0 - 2026-05-25
- Added descriptions to heatmap and session recording creation forms
- Updated heatmap and session recording creation inline helptexts

5.3.5 - 2026-04-14
- Added code to ignore paused state when deleting logs

5.3.4 - 2026-04-13
- Added code to block more xss tags
...
5.2.7 - 2025-09-29
- Adjusted action icons to ensure that delete is last
