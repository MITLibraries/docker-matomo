      ...
      <div>
        <div name="name">
          <Field
            ...
            :inline-help="translate('HeatmapSessionRecording_SessionNameHelpText')"
          >
          </Field>
        </div>
        ...
        <div name="autoRepeat">
          <Field
            uicontrol="checkbox"
            name="auto_repeat"
            :title="translate('HeatmapSessionRecording_AutoRepeatSessionRecording')"
...
export default defineComponent({
  ...
  computed: {
    ...
    autoRepeatHelp() {
      ...
      return translate(
        'HeatmapSessionRecording_AutoRepeatSessionRecordingHelp',
        `<a href="${link}" target="_blank" rel="noopener noreferrer">`,
        '</a>',
      );
    },
    ...
    targetHelpText() {
      ...
      const key = this.showAdvancedTargeting
        ? 'HeatmapSessionRecording_FieldIncludedTargetsHelpAdvancedSessions'
        : 'HeatmapSessionRecording_FieldIncludedTargetsHelpSimpleSessions';
