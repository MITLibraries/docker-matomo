...
<template>
  <div class="heatmapList">
      ...
      <table v-content-table v-tooltips>
        <thead>
          <tr>
            ...
            <th class="autoRepeat">
              {{ translate('HeatmapSessionRecording_AutoRepeatHeatmapColumn') }}
              <span
                class="icon-info"
                :title="translate('HeatmapSessionRecording_AutoRepeatHeatmapColumnHelp')"
              ></span>
            </th>
    ...
    >
      ...
      >
        {{ translate('HeatmapSessionRecording_EndHeatmapRepeatNotice') }}
      </p>
      <input
        role="yes"
        type="button"
...
export default defineComponent({
  ...
  methods: {
    ...
    onHoldReason(hsr: Heatmap) {
      return translate(
        'HeatmapSessionRecording_StatusOnHoldHelp',
