...
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Cookie\CookieJar;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Exception\GuzzleException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \Matomo\Dependencies\SearchEngineKeywordsPerformance\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
