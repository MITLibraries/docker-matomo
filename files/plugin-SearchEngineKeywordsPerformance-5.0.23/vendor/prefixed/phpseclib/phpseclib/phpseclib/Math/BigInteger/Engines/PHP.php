 ...
 */
namespace Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Math\BigInteger\Engines;
...
abstract class PHP extends Engine
{
    ...
    protected static function testJITOnWindows()
    {
        ...
        if (strtoupper(substr(\PHP_OS, 0, 3)) === 'WIN' && function_exists('opcache_get_status') && \PHP_VERSION_ID < 80213 && !defined('Matomo\\Dependencies\\SearchEngineKeywordsPerformance\\PHPSECLIB_ALLOW_JIT')) {
