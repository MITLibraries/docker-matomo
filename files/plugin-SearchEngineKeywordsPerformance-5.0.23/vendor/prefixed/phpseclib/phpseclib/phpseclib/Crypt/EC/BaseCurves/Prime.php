 ...
 */
namespace Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\EC\BaseCurves;
...
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Math\Common\FiniteField\Integer;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Math\PrimeField;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + b
 *
 * @author  Jim Wigginton <terrafrost@php.net>
