...
abstract class ReportType
{
    ...
    /**
     * The maximum number of metrics that can be configured for this report type, or null for no limit.
     *
     * @return int|null
     */
    public function getMaxMetrics()
    {
        return null;
    }

    /**
     * Whether this report type archives one numeric record per metric (in addition to the blob record).
     *
     * @return bool
     */
    public function usesNumericRecords()
    {
        return false;
    }
    ...
    {
        return array(new Table(), new Evolution(), new KpiCard());
    }
