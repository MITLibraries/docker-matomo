...
5.5.0 - 2026-08-03
- Added new "KPI card" report type showing a single metric with a sparkline and a comparison to the previous period
- Added code to allow using country and continent dimensions together

5.4.14 - 2026-07-21
- Updated Marketplace description
- Updated check for existing mapped idSites scope before updating
- Normalized website IDs for reports mapped to multiple sites

5.4.13 - 2026-06-29
- Added code to check existing mapped idSites scope before updating
- Fixed dark mode colours for metric and dimension dropdowns in the report editor

5.4.12 - 2026-05-19
- Updated custom report creation inline helptexts
- Improved visual consistency of creation form layout
- Fixed dark mode incompability with older Matomo versions
