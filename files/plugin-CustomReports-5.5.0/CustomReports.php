 ...
 * Description: Standard reports answer common analytics questions. Custom Reports answers your questions. Build custom reporting views tailored to your goals, KPIs, and business requirements.
 * Author: InnoCraft
...
class CustomReports extends \Piwik\Plugin
{
    ...
    public function getStylesheetFiles(&$stylesheets)
    {
        ...
        $stylesheets[] = "plugins/CustomReports/vue/src/KpiCardView/KpiCardView.less";
    }
    ...
    public function getClientSideTranslationKeys(&$result)
    {
        ...
        $result[] = 'CustomReports_ReportNameHelpText';
        $result[] = 'CustomReports_ReportDescriptionHelpText';
        ...
        $result[] = 'CustomReports_ReportSingleMetricHelp';
