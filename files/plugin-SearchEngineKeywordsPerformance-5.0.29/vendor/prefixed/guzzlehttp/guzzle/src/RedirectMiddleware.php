...
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Exception\BadResponseException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\GuzzleHttp\Exception\TooManyRedirectsException;
