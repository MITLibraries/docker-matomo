 ...
 */
namespace Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Net;

use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Common\Functions\Strings;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Blowfish;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\ChaCha20;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Common\AsymmetricKey;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Common\PrivateKey;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Common\PublicKey;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Common\SymmetricKey;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\DH;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\DSA;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\EC;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Hash;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Random;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\RC4;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Rijndael;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\RSA;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\TripleDES;
// Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Crypt\Twofish;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Exception\ConnectionClosedException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Exception\InsufficientSetupException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Exception\InvalidPacketLengthException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Exception\NoSupportedAlgorithmsException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Exception\TimeoutException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Exception\UnableToConnectException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Exception\UnsupportedAlgorithmException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Exception\UnsupportedCurveException;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\Math\BigInteger;
use Matomo\Dependencies\SearchEngineKeywordsPerformance\phpseclib3\System\SSH\Agent;
/**
 * Pure-PHP implementation of SSHv2.
 *
 * @author  Jim Wigginton <terrafrost@php.net>
...
class SSH2
{
    ...
    private function connect()
    {
        ...
        if (!is_resource($this->fsock)) {
            ...
            if (defined('Matomo\\Dependencies\\SearchEngineKeywordsPerformance\\NET_SSH2_LOGGING')) {
    ...
    {
        if (defined('Matomo\\Dependencies\\SearchEngineKeywordsPerformance\\NET_SSH2_LOGGING') && NET_SSH2_LOGGING == self::LOG_COMPLEX) {
