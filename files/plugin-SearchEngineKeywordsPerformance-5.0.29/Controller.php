...
class Controller extends \Piwik\Plugin\ControllerAdmin
{
    ...
    private function toProviderArray(ProviderAbstract $provider)
    {
        ...
        $configuredSiteIds = $this->redactMeasurableDataIfRequired($mappingToPick['key'], $provider->getConfiguredSiteIds(), $mappingToPick['length']);
        return [
            'id' => $provider->getId(),
            'is_configured' => $provider->isConfigured(),
            'configured_site_ids' => $configuredSiteIds,
