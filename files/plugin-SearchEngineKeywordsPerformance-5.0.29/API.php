...
/**
 * Provides SearchEngineKeywordsPerformance API endpoints for imported keyword and crawl-performance reports.
 * Exposes combined and provider-specific reports for Google, Bing, and Yandex search data.
 *
 * @package Piwik\Plugins\SearchEngineKeywordsPerformance
 * @method static \Piwik\Plugins\SearchEngineKeywordsPerformance\API getInstance()
 */
class API extends \Piwik\Plugin\API
{
    /**
     * Returns keyword performance data across imported search engines and Matomo referrer keywords.
     *
     ...
     * @return DataTable|DataTable\Map Combined keyword report including imported search data and referrer keywords.
     */
    ...
    /**
     * Returns keyword performance data imported from supported search engines.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Combined imported keyword report across all configured providers.
     */
    ...
    /**
     * Returns keyword performance data imported from Google search properties.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Combined Google keyword report across web, image, video, and news search.
     */
    ...
    /**
     * Returns keyword performance data imported from Bing and Yahoo search.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Bing keyword report for the requested period or an empty table when unsupported.
     */
    ...
    /**
     * Returns keyword performance data imported from Yandex search.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Yandex keyword report for the requested period.
     */
    ...
    /**
     * Returns keyword performance data imported from Google web search.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Google web search keyword report.
     */
    ...
    /**
     * Returns keyword performance data imported from Google image search.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Google image search keyword report.
     */
    ...
    /**
     * Returns keyword performance data imported from Google video search.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Google video search keyword report.
     */
    ...
    /**
     * Returns keyword performance data imported from Google news search.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Google news search keyword report.
     */
    ...
    /**
     * Returns Bing crawl overview metrics for the requested site selection.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Bing crawl overview metrics aggregated from archived numeric records.
     */
    ...
    /**
     * Returns Yandex crawl overview metrics for the requested site selection.
     *
     * @param int|string|int[] $idSite Website ID(s) to query.
     *                                 - Single site ID (e.g. 1)
     *                                 - Multiple site IDs (e.g. [1, 4, 5])
     ...
     *                     'YYYY-MM-DD', magic keywords (today, yesterday, lastWeek, lastMonth, lastYear),
     *                     or date range (ie, 'YYYY-MM-DD,YYYY-MM-DD', lastX, previousX).
     * @return DataTable|DataTable\Map Yandex crawl overview metrics aggregated from archived numeric records.
     */
    ...
    /**
     * Returns the latest imported Bing crawl error examples for a single site.
     *
     * @param int|string $idSite The numeric ID of the website to query.
     * @return DataTable Bing crawl error example rows from the latest imported dataset.
     */
